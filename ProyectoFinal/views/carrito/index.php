            ...
            <table class="table">
                ...
                foreach ($carrito as $indice => $elemento) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="mt-4">
                                <a class="h5" href="index.php?controller=producto&action=ver&id=<?= $producto->id ?>"><?= $producto->nombre ?></a>
                            </div>
                        </td>
                        <td>
                        ...
                        <script type="text/javascript">
                            ...
                            var uni = <?= $elemento['unidades'] ?>;


                            //Funcion para añadir unidades con ajax
                            function addProd(indi) {
                                ...
                                xhttp.onreadystatechange = function() {
                                    if (cont <= stock) {
                                        if (this.readyState == 4 && this.status == 200) {
                                            ...
                                            uni = document.getElementById("uni" + indi).innerHTML;
                                ...
                                if (cont < stock) {
                                    ...
                                    Swal.fire({
                                        title: '<strong>No puedes añadir más libros</strong>',
                                        type: 'info'
                        ...
                        <td>
                            ...
                            <div class="updown-unidades mt-3">
                                <button onclick="addProd(<?= $indice ?>)" class='btn-success text-white p-2 border-0'>
                                    +
                                </button>

                                <button class='btn-success text-white p-2 border-0'><a href="index.php?controller=carrito&action=down&index=<?= $indice ?>" id="res2" class="text-white">-</a></button>
                            </div>
                        </td>
                        <td>
                            <a href="index.php?controller=carrito&action=delete&index=<?= $indice ?>" class='btn btn-danger text-white mt-4'>Quitar producto</a>
                        </td>
                    </tr>
                <?php
            } ?>
